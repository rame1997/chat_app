...
import 'package:chat_app/helper/debouncer.dart';
import 'package:chat_app/helper/utilities.dart';
import 'package:chat_app/providers/auth_provider.dart';
import 'package:chat_app/model/popup_choices.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: Image.asset('images/logoArabicOnBording.png'),
        elevation: 0,
